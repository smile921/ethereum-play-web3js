...
// import Config from '../../config/emvironment';
...
export default Ember.Component.extend({
    ...
    init:function() { 
        ...
        // debugger;
        let baseAddr = webInstance.eth.coinbase;
        let deployData = get(this,'deployData');
        deployData.addr = baseAddr;
        deployData.gas = webInstance.eth.getBalance(baseAddr);
        deployData.gas = webInstance.fromWei(deployData.gas,'ether');
        set(this,'deployData',deployData);
